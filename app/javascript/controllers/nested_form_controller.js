...
export default class extends Controller {
  ...
  add_association(event) {
    ...
    var order = this.linksTarget.previousElementSibling
      ? this.linksTarget.previousElementSibling.dataset["order"]
      : null;
    if (order == null) {
      order = 0;
    } else {
    ...
    this.linksTarget.previousElementSibling.dataset.order = order;
    this.linksTarget.previousElementSibling.getElementsByClassName(
      "order-field"
    )[0].value = order;
  }
